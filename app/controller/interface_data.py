...
def get_actions_list() -> list:
    ...
    list_action = [
        ...
        Action('open_pdd_action', 'Открыть *.pdd', ':file.svg',
               'Открыть pdd файл с данными.', None, False, ('get_open_file_window', 'pdd')),
        Action('open_csv_action', 'Открыть *.csv', ':file-text.svg',
               'Открыть csv файл с данными.', None, False, ('get_open_file_window', 'csv')),
        ...
        Action('create_graph_on_time_action', 'Создать график по времени', ':minimize.svg',
               'Создать график в новом окне по отрезку времени', None, False, 'create_graph_on_time'),
